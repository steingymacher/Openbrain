      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed right-4 bottom-4 sm:right-8 sm:bottom-8 w-[calc(100%-2rem)] sm:w-[420px] h-[75vh] sm:h-[650px] max-h-[650px] sm:max-h-[85vh] bg-white dark:bg-[#1a1a1a] rounded-[32px] sm:rounded-[40px] shadow-2xl z-[10000] flex flex-col overflow-hidden duration-300 transition-colors"
          >
            {/* Header */}
